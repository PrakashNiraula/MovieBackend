...
<div id="sidebar-menu" class="main_menu_side hidden-print main_menu menu_fixed">
    <div class="menu_section">
        ...
        <ul class="nav side-menu">
            ...
            <li>
                <a>
                    <i class="fa fa-cogs"></i> Shop Settings <span class="fa fa-chevron-down"></span></a>
                <ul class="nav child_menu">

                    <li><a href="appsettings.php">Main Settings</a></li>                      
                    <li><a href="editresdetails.php">Shop Details</a></li>
...
<li><a href="profile.php"><i class="fa fa-github-alt"></i> Admin Settings</a></li>
            ...
            <li>
                <a href="menuitem.php"><i class="fa fa-film"></i> Shop Item </a>
