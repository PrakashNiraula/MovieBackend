...
// if everything is ok, try to upload file
    ...
    move_uploaded_file($_FILES["primary"]["tmp_name"], $target_file);
         ...
         $insertplacemain = "UPDATE app_productsmain Set primary_image='".$target_file1."' where id='".$id."'";

        $success = mysqli_query($conn, $insertplacemain);

        
 $insertplacemain = "UPDATE app_products Set primary_image='".$target_file1."' where product_id='".$product_id."'";
