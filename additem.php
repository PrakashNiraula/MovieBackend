                    ...
                    <div class="x_content">
                        ...
                        <form role="form" method="POST" enctype="multipart/form-data" action="item-process.php" name="form1" onsubmit="required()"  >
                            ...
                            <div class="form-group">
                                <label>Movie Name:</label> <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="Enter name of your menu item"></i>
                                <input type="text" class="form-control" placeholder="Enter name of movie" name="name" required>
                            </div>


                            <div class="form-group">
                                <label>Movie Description:</label> <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="Enter description of your menu item"></i>
                            ...
                            <div class="form-group">
                                <label>Item Variant:</label> <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="Enter variant of your menu item"></i>
                                <table id="employee_table" align=center class="table table-striped">
                                    <th>Variant Size</th>
                                    <th>Variant Price</th>
                                    <tr id="row1">
                                        <td><input type="text" name="vname[]" placeholder="Size of your movie" class="form-control" required></td>
...
<div class="form-group">
                            ...
                            <div class="box-footer">
                                <input type="submit" class="btn btn-primary" value="Add Item" name="addproduct" id="postme" disabled title='Fill all the deatails completely'>
