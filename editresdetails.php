                        ...
                        <div class="modal-body">
                            ...
                            <form class="forms-sample" method="POST" action="updateresdetails.php" enctype="multipart/form-data">
                                <div class="form-group">
                                    ...
                                    <label for="exampleInputEmail1">Shop Name</label> <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="Add name of your restaurant."></i>
                                ...
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Shop Address</label> <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="Add address of your restaurant."></i>
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Shop Description</label> <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="Add description of your restaurant."></i>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php if ($imagecounter == 0) { ?>
                                            ...
                                            <div class="form-group"><br>
                                                ...
                                                <label for="exampleInputFile">Shop Images</label> <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="Add at least one image of your product."></i>
                                                <br>
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <input type="submit" value="Update Details" class="btn btn-primary mr-2" name="update">
                                                </div>
